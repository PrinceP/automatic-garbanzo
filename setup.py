...
setup(name = 'myModule', version = '1.0',  \
   ext_modules = [
      ...
      include_dirs=[np.get_include(), os.path.join(CUDA_HOME, "include"), OPENCV_INCLUDE],
      libraries=["preprocess", "cudart", "opencv_core", "opencv_imgproc", "opencv_imgcodecs"],
      ...
      library_dirs = ["./preprocess_test/build", os.path.join(CUDA_HOME, "lib64"), OPENCV_LIBS],
